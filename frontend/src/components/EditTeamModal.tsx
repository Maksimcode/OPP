...
export const EditTeamModal = ({ isOpen, onClose, onSubmit, currentName }: EditTeamModalProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ fontSize: "1.5rem", marginBottom: "1rem", color: "#1d4ed8" }}>Редактировать команду</h2>
        <p style={{ color: "#475569", marginBottom: "1.5rem" }}>Измените название команды</p>
